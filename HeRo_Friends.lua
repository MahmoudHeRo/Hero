...
function applyImage(imageNumber, imageName)
    ...
    gg.sleep(500)
    gg.toast("✅ تم استبدال " .. (imageName or "الصورة " .. imageNumber))
end
...
gg.alert("mahmouddhero تم تحديث تطبيق الاسكربت عليك الذهاب الي الموقع وتحميل احدث اصدار من التطبيق بعد التحديث سوف تظهر هذه الرسالة مره اخري حتي يشاهد الجميع الرساله بعد التحديث يممن للجميع ان يعمل علي نطاقات الذاكرة بدون مشاكر اذا منت لا تفهم تحدث نع مطور الاسكربت لتواصل علي ماسنجر اكتب الاسم دا وركز في الاسم فيه حرفين زي بعض ")
...
--اكواد بالون طائرة من قسم اكواد الزينه 
function UU1()
    lastMenu = UU1
    MH = gg.multiChoice({
        "╔══════⟬🎈⟭══════╗\n𝄟              بالون الببغاء            𝄟\n╚═══════════════╝",--1
